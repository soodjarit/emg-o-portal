...
<div class="layout">
  ...
  <div class="flow-banner">
    ...
    <b style="color:var(--red)">🔴 พบปัญหาบัญชีจริง — ยังไม่ได้แก้ไข:</b> ใบส่งของ (Delivery) ของ FG ไม่ได้ลงบัญชีต้นทุนขาย (COGS) เลยสักบาท มูลค่า Slab ที่ใช้ผลิตค้างอยู่ในบัญชี "Inventory - Stone FG" ตลอดไปแม้ส่งมอบสินค้าไปแล้ว — แจ้งผู้ใช้แล้ว ยังไม่ได้ลงมือแก้เนื่องจากเป็นเรื่องการออกแบบบัญชีที่ต้องตัดสินใจก่อน ดูรายละเอียดที่ TC-12
  </div>
